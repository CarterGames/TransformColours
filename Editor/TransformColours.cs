...
{
    /// <summary>
    /// Controls the custom inspector for the transform component, just comment out or remove the script to get the normal inspector back.
    /// </summary>
    ...
    public class TransformColours : Editor
    {
        ...
        // Hidden Colour
        private readonly Color hidden = new Color(0, 0, 0, .3f);
        ...
        private void PositionInspector()
        {
            ...
            // Position X - Red
            GUI.backgroundColor = CustomiseColoursEditorWindow.GetColour(XString);
            EditorGUILayout.PropertyField(posX, new GUIContent("X"));
            GUI.backgroundColor = Color.white;

            // Position Y - Green
            GUI.backgroundColor = CustomiseColoursEditorWindow.GetColour(YString);
            ...
            {
                // Position Z - Blue
                GUI.backgroundColor = CustomiseColoursEditorWindow.GetColour(ZString);
